...
UI.addLabel(logregScreen, UI.createLabel("RangerBank V2.0", UI.screenWidth-14, UI.screenHeight, colors.black, colors.blue))
UI.addLabel(registerScreen, UI.createLabel("RangerBank V2.0", UI.screenWidth-14, UI.screenHeight, colors.black, colors.blue))
UI.addLabel(loginScreen, UI.createLabel("RangerBank V2.0", UI.screenWidth-14, UI.screenHeight, colors.black, colors.blue))
UI.addLabel(mainScreen, UI.createLabel("RangerBank V2.0", UI.screenWidth-14, UI.screenHeight, colors.black, colors.blue))
UI.addLabel(accountScreen, UI.createLabel("RangerBank V2.0", UI.screenWidth-14, UI.screenHeight, colors.black, colors.blue))
UI.addLabel(delaccScreen, UI.createLabel("RangerBank V2.0", UI.screenWidth-14, UI.screenHeight, colors.black, colors.blue))
UI.addLabel(changepassScreen, UI.createLabel("RangerBank V2.0", UI.screenWidth-14, UI.screenHeight, colors.black, colors.blue))
UI.addLabel(moneyScreen, UI.createLabel("RangerBank V2.0", UI.screenWidth-14, UI.screenHeight, colors.black, colors.blue))
UI.addLabel(transferScreen, UI.createLabel("RangerBank V2.0", UI.screenWidth-14, UI.screenHeight, colors.black, colors.blue))
UI.addLabel(logsScreen, UI.createLabel("RangerBank V2.0", UI.screenWidth-14, UI.screenHeight, colors.black, colors.blue))
