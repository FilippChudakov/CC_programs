local files = {
    {   -- /
        url = "https://raw.githubusercontent.com/FilippChudakov/CC_programs/refs/heads/main/RangerBank/RangerBankClient/RangerBank.lua",
        path = "RangerBank.lua"
    },
    {   -- /APIS/
    ...
    {   
        url = "https://raw.githubusercontent.com/FilippChudakov/CC_programs/refs/heads/main/RangerBank/RangerBankClient/APIS/ShortCuts.lua",
        path = "APIS/ShortCuts.lua"
    },
    {   
        url = "https://raw.githubusercontent.com/FilippChudakov/CC_programs/refs/heads/main/RangerBank/RangerBankClient/APIS/UI.lua",
        path = "APIS/UI.lua"
    },
    {   -- /RangerBankData/
        url = "https://raw.githubusercontent.com/FilippChudakov/CC_programs/refs/heads/main/RangerBank/RangerBankClient/RangerBankData/Secure.txt",
        path = "RangerBankData/Secure.txt"
    }
}
...
print("\nDownload complete!\n\nIf you need, you can delete setup with:\ndelete RB-App.setup.lua\n\nTo run app write: RangerBank")
